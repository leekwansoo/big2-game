        ...
        <div className="p-4">
            ...
            <div className="grid grid-cols-1 gap-4">
                {players.map((hand, index) => (
                    <div key={index} className="flex flex-col items-center gap-4 h-24 m-4" >
                        ...
                        <div className="flex-row h-32 margin">
                            {hand
                                .slice()
                                ...
                                .map((card, cardIndex) => (
                                    <div key={cardIndex} className="relative mr-2">
                                        ...
                                        <Card
                                            ...
                                            ) ? 'border-2 border-blue' : 'border border-gray'
                                                }`}
                ...
                <div className="flex-row justify-center items-center bg-white/90 p-5 mb-24 margin h-24">

                    <div className="flex gap-2">
                        <p className="text-2xl font-bold mb-4">마지막 플레이:</p>
            ...
            <div className="bg-white/90 p-3 rounded-lg shadow-md z-10 text-center">
                <button
                    onClick={handlePlay}
                    className="text-2xl bg-blue text-red rounded hover:bg-blue 
